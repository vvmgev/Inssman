  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        recorderWidget: resolve(__dirname, "src/cotentScript/recorderWidget.ts"),
        setupContentConfig: resolve(__dirname, "src/cotentScript/setupContentConfig.ts"),
        ...
        iframeContentScript: resolve(__dirname, "src/iframeContentScript/iframeContentScript.ts"),
        HTTPLoggerWindow: resolve(__dirname, "src/HTTPLoggerWindow/HTTPLoggerWindow.tsx"),
      },
      output: {
