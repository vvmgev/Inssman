...
export const FeatureToggleContext = createContext({toggles: {} as FeatureToggleValue});
...
const FeatureToggleProvider: FC<Props> = ({ children }) => {
  ...
  useEffect(() => {
    const getConfig = async () => {
      ...
      data.featureToggles.featureShowRecord = true;
  ...
  return <FeatureToggleContext.Provider value={{toggles}}>
    {children}
