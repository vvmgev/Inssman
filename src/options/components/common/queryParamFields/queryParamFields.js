...
function QueryParamFields({
  queryParams, onChangeParam, onRemove, error,
}) {
  const queryParamActionOptions = useMemo(() => Object.entries(QueryParamAction).reduce((previous, [value, label]) => {
